...
export declare const networks: {
    readonly standalone: {
        ...
        readonly contractId: "CBYFYBXFIWEZIWR3AFCYHJY2ZHBUTOWB2CKCXQQ3NVZCJQGBMWOIR3K7";
    };
};
export type DataKey = {
    tag: "Admin";
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        get_pool: (json: string) => AssembledTransaction<PoolInfo>;
        get_pools: (json: string) => AssembledTransaction<PoolInfo[]>;
    };
}
